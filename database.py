...
def save_otp(
    ...
    # Remove old OTPs for this identifier/purpose
    old_otps = (
...
async def forgot_password_request_otp(
    ...
    # OTP is sent/identified using the registered mobile number
    otp = save_otp(
        db,
        user.mobile,
        "forgot_password"
...
async def reset_password(
    ...
    # Verification also expires after 2 minutes
    if datetime.utcnow() > verification.expires_at:
    ...
    # Make the verification single-use
    verification.verified = False
